...
<html>
	...
	<body>
		<div class="backimg">
		<div id = "wrap">
		<form id="userUpdate" name="userUpdate" method="post"  action="<c:url value='/profile/userUpdate'/>">
			<table>
				<thead> 
					<tr>
				...
				<tbody>
					...
					<tr>
						<td colspan="2">
							<div>
								<label><input type="text" class="essential" id="id" name="userId" value="${userId }" readonly></label>
							</div>
							<div>
				...
				<tfoot>
					<tr>
						<td colspan="2"><button id="joinBtn">수정하기</button></td>
					</tr>
				</tfoot>
			</table>
			</form>
