...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<div class="footer">
			<div class="footer-box-wrapper" id="wrap">
				...
				<a href="#"><img src="<c:url value='/image/logo_winter_end.gif'/>" alt="이미지를 불러오지 못했습니다."></a>
				</div>
				<div class="footer-box">
				<span class="style2">
					&nbsp;
				...
				<p />
				<span class="style2">
					<a href="404.html">이용 약관</a><br>
					<a href="404.html">개인 정보 정책</a>
				</span>
				</div>
			</div>
			<div class="style2" id="wrap">© 2022 뚜벅뚜벅. All rights reserved.<a type="button" class="summer" href="404.html">
			<img src="<c:url value='/image/season-winter.jpg/'/>"></a></div>
			<br />
			<p></p>
			<p></p>
		</div>