	...
	<section>
		<div id="searchBox" style="width: 1200px">
			<!--서치 박스 시작 -->
				...
				<input id="searchBar" type="search" value="" name="keyword" placeholder="search..." />
		...
		<div id="subFilterBox">
			...
			<div class="subFilter" id="filter2">
				<span>지역 : </span> <label><input type="checkbox" id="filter"
					name="filter" value="서울" />서울</label> <label><input
					type="checkbox" id="filter" name="filter" value="경기도" /> 경기도</label>
				<label><input type="checkbox" id="filter" name="filter"
					value="강원도" /> 강원도</label> <label><input type="checkbox"
					id="filter" name="filter" value="충청도" /> 충청도</label> <label><input
					type="checkbox" id="filter" name="filter" value="경상도" /> 경상도</label>
				<label><input type="checkbox" id="filter" name="filter"
					value="전라도" /> 전라도</label> <label><input type="checkbox"
					id="filter" name="filter" value="제주" /> 제주</label>
			</div>
			<div class="subFilter" id="filter3">
				<span>테마 : </span> <label><input type="checkbox" id="filter"
					name="filter" value="호수" /> 산</label> <label><input
					type="checkbox" id="filter" name="filter" value="호수" /> 바다</label> <label><input
					type="checkbox" id="filter" name="filter" value="호수" /> 호수</label> <label><input
					type="checkbox" id="filter" name="filter" value="맛집" /> 맛집</label> <label><input
					type="checkbox" id="filter" name="filter" value="쇼핑" /> 쇼핑</label> <label><input
					type="checkbox" id="filter" name="filter" value="어린이" /> 어린이</label>
				<label><input type="checkbox" id="filter" name="filter"
					value="당일" /> 당일</label>
			</div>
		</div>
